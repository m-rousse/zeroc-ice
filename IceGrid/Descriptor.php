...
if(!class_exists('IceGrid_PropertyDescriptor'))
{
    class IceGrid_PropertyDescriptor
    {
    ...
    $IceGrid__t_PropertyDescriptor = IcePHP_defineStruct('::IceGrid::PropertyDescriptor', 'IceGrid_PropertyDescriptor', array(
...
if(!class_exists('IceGrid_PropertySetDescriptor'))
{
    class IceGrid_PropertySetDescriptor
    {
    ...
    $IceGrid__t_PropertySetDescriptor = IcePHP_defineStruct('::IceGrid::PropertySetDescriptor', 'IceGrid_PropertySetDescriptor', array(
...
if(!class_exists('IceGrid_ObjectDescriptor'))
{
    class IceGrid_ObjectDescriptor
    {
    ...
    $IceGrid__t_ObjectDescriptor = IcePHP_defineStruct('::IceGrid::ObjectDescriptor', 'IceGrid_ObjectDescriptor', array(
...
if(!class_exists('IceGrid_AdapterDescriptor'))
{
    class IceGrid_AdapterDescriptor
    {
    ...
    $IceGrid__t_AdapterDescriptor = IcePHP_defineStruct('::IceGrid::AdapterDescriptor', 'IceGrid_AdapterDescriptor', array(
        array('name', $IcePHP__t_string), 
...
if(!class_exists('IceGrid_DbEnvDescriptor'))
{
    class IceGrid_DbEnvDescriptor
    {
    ...
    $IceGrid__t_DbEnvDescriptor = IcePHP_defineStruct('::IceGrid::DbEnvDescriptor', 'IceGrid_DbEnvDescriptor', array(
        array('name', $IcePHP__t_string), 
        array('description', $IcePHP__t_string), 
...
global $IceGrid__t_CommunicatorDescriptorPrx;

if(!class_exists('IceGrid_CommunicatorDescriptor'))
{
    class IceGrid_CommunicatorDescriptor extends Ice_ObjectImpl
    {
        public function __construct($adapters=null, $propertySet=null, $dbEnvs=null, $logs=null, $description='')
        {
            $this->adapters = $adapters;
            $this->propertySet = is_null($propertySet) ? new IceGrid_PropertySetDescriptor : $propertySet;
            $this->dbEnvs = $dbEnvs;
            $this->logs = $logs;
            $this->description = $description;
        }
    ...
    class IceGrid_CommunicatorDescriptorPrxHelper
    {
    ...
    $IceGrid__t_CommunicatorDescriptor = IcePHP_defineClass('::IceGrid::CommunicatorDescriptor', 'IceGrid_CommunicatorDescriptor', -1, false, false, $Ice__t_Object, null, array(
...
if(!class_exists('IceGrid_DistributionDescriptor'))
{
    class IceGrid_DistributionDescriptor
    {
    ...
    $IceGrid__t_DistributionDescriptor = IcePHP_defineStruct('::IceGrid::DistributionDescriptor', 'IceGrid_DistributionDescriptor', array(
        array('icepatch', $IcePHP__t_string), 
        array('directories', $Ice__t_StringSeq)));
}

global $IceGrid__t_ServerDescriptor;
global $IceGrid__t_ServerDescriptorPrx;

if(!class_exists('IceGrid_ServerDescriptor'))
{
    class IceGrid_ServerDescriptor extends IceGrid_CommunicatorDescriptor
    {
        public function __construct($adapters=null, $propertySet=null, $dbEnvs=null, $logs=null, $description='', $id='', $exe='', $iceVersion='', $pwd='', $options=null, $envs=null, $activation='', $activationTimeout='', $deactivationTimeout='', $applicationDistrib=false, $distrib=null, $allocatable=false, $user='')
        {
            ...
            $this->distrib = is_null($distrib) ? new IceGrid_DistributionDescriptor : $distrib;
    ...
    class IceGrid_ServerDescriptorPrxHelper
    {
        public static function checkedCast($proxy, $facetOrCtx=null, $ctx=null)
        {
    ...
    $IceGrid__t_ServerDescriptor = IcePHP_defineClass('::IceGrid::ServerDescriptor', 'IceGrid_ServerDescriptor', -1, false, false, $IceGrid__t_CommunicatorDescriptor, null, array(
...
global $IceGrid__t_ServiceDescriptorPrx;

if(!class_exists('IceGrid_ServiceDescriptor'))
{
    class IceGrid_ServiceDescriptor extends IceGrid_CommunicatorDescriptor
    {
    ...
    class IceGrid_ServiceDescriptorPrxHelper
    {
        public static function checkedCast($proxy, $facetOrCtx=null, $ctx=null)
        {
    ...
    $IceGrid__t_ServiceDescriptor = IcePHP_defineClass('::IceGrid::ServiceDescriptor', 'IceGrid_ServiceDescriptor', -1, false, false, $IceGrid__t_CommunicatorDescriptor, null, array(
...
if(!class_exists('IceGrid_ServerInstanceDescriptor'))
{
    class IceGrid_ServerInstanceDescriptor
    {
    ...
    $IceGrid__t_ServerInstanceDescriptor = IcePHP_defineStruct('::IceGrid::ServerInstanceDescriptor', 'IceGrid_ServerInstanceDescriptor', array(
...
if(!class_exists('IceGrid_TemplateDescriptor'))
{
    class IceGrid_TemplateDescriptor
    {
    ...
    $IceGrid__t_TemplateDescriptor = IcePHP_defineStruct('::IceGrid::TemplateDescriptor', 'IceGrid_TemplateDescriptor', array(
...
if(!class_exists('IceGrid_ServiceInstanceDescriptor'))
{
    class IceGrid_ServiceInstanceDescriptor
    {
    ...
    $IceGrid__t_ServiceInstanceDescriptor = IcePHP_defineStruct('::IceGrid::ServiceInstanceDescriptor', 'IceGrid_ServiceInstanceDescriptor', array(
        array('template', $IcePHP__t_string), 
        array('parameterValues', $IceGrid__t_StringStringDict), 
...
global $IceGrid__t_IceBoxDescriptorPrx;

if(!class_exists('IceGrid_IceBoxDescriptor'))
{
    class IceGrid_IceBoxDescriptor extends IceGrid_ServerDescriptor
    {
    ...
    class IceGrid_IceBoxDescriptorPrxHelper
    {
        public static function checkedCast($proxy, $facetOrCtx=null, $ctx=null)
        {
    ...
    $IceGrid__t_IceBoxDescriptor = IcePHP_defineClass('::IceGrid::IceBoxDescriptor', 'IceGrid_IceBoxDescriptor', -1, false, false, $IceGrid__t_ServerDescriptor, null, array(
...
if(!class_exists('IceGrid_NodeDescriptor'))
{
    class IceGrid_NodeDescriptor
    {
    ...
    $IceGrid__t_NodeDescriptor = IcePHP_defineStruct('::IceGrid::NodeDescriptor', 'IceGrid_NodeDescriptor', array(
...
global $IceGrid__t_LoadBalancingPolicyPrx;

if(!class_exists('IceGrid_LoadBalancingPolicy'))
{
    class IceGrid_LoadBalancingPolicy extends Ice_ObjectImpl
    {
    ...
    class IceGrid_LoadBalancingPolicyPrxHelper
    {
        public static function checkedCast($proxy, $facetOrCtx=null, $ctx=null)
        {
    ...
    $IceGrid__t_LoadBalancingPolicy = IcePHP_defineClass('::IceGrid::LoadBalancingPolicy', 'IceGrid_LoadBalancingPolicy', -1, false, false, $Ice__t_Object, null, array(
...
global $IceGrid__t_RandomLoadBalancingPolicyPrx;

if(!class_exists('IceGrid_RandomLoadBalancingPolicy'))
{
    class IceGrid_RandomLoadBalancingPolicy extends IceGrid_LoadBalancingPolicy
    {
        public function __construct($nReplicas='')
        {
    ...
    class IceGrid_RandomLoadBalancingPolicyPrxHelper
    {
        public static function checkedCast($proxy, $facetOrCtx=null, $ctx=null)
        {
    ...
    $IceGrid__t_RandomLoadBalancingPolicy = IcePHP_defineClass('::IceGrid::RandomLoadBalancingPolicy', 'IceGrid_RandomLoadBalancingPolicy', -1, false, false, $IceGrid__t_LoadBalancingPolicy, null, null);
...
global $IceGrid__t_OrderedLoadBalancingPolicyPrx;

if(!class_exists('IceGrid_OrderedLoadBalancingPolicy'))
{
    class IceGrid_OrderedLoadBalancingPolicy extends IceGrid_LoadBalancingPolicy
    {
        public function __construct($nReplicas='')
        {
            parent::__construct($nReplicas);
    ...
    class IceGrid_OrderedLoadBalancingPolicyPrxHelper
    {
        public static function checkedCast($proxy, $facetOrCtx=null, $ctx=null)
        {
    ...
    $IceGrid__t_OrderedLoadBalancingPolicy = IcePHP_defineClass('::IceGrid::OrderedLoadBalancingPolicy', 'IceGrid_OrderedLoadBalancingPolicy', -1, false, false, $IceGrid__t_LoadBalancingPolicy, null, null);
...
global $IceGrid__t_RoundRobinLoadBalancingPolicyPrx;

if(!class_exists('IceGrid_RoundRobinLoadBalancingPolicy'))
{
    class IceGrid_RoundRobinLoadBalancingPolicy extends IceGrid_LoadBalancingPolicy
    {
        public function __construct($nReplicas='')
        {
            parent::__construct($nReplicas);
    ...
    class IceGrid_RoundRobinLoadBalancingPolicyPrxHelper
    {
        public static function checkedCast($proxy, $facetOrCtx=null, $ctx=null)
        {
    ...
    $IceGrid__t_RoundRobinLoadBalancingPolicy = IcePHP_defineClass('::IceGrid::RoundRobinLoadBalancingPolicy', 'IceGrid_RoundRobinLoadBalancingPolicy', -1, false, false, $IceGrid__t_LoadBalancingPolicy, null, null);
...
global $IceGrid__t_AdaptiveLoadBalancingPolicyPrx;

if(!class_exists('IceGrid_AdaptiveLoadBalancingPolicy'))
{
    class IceGrid_AdaptiveLoadBalancingPolicy extends IceGrid_LoadBalancingPolicy
    {
    ...
    class IceGrid_AdaptiveLoadBalancingPolicyPrxHelper
    {
        public static function checkedCast($proxy, $facetOrCtx=null, $ctx=null)
        {
    ...
    $IceGrid__t_AdaptiveLoadBalancingPolicy = IcePHP_defineClass('::IceGrid::AdaptiveLoadBalancingPolicy', 'IceGrid_AdaptiveLoadBalancingPolicy', -1, false, false, $IceGrid__t_LoadBalancingPolicy, null, array(
...
if(!class_exists('IceGrid_ReplicaGroupDescriptor'))
{
    class IceGrid_ReplicaGroupDescriptor
    {
    ...
    $IceGrid__t_ReplicaGroupDescriptor = IcePHP_defineStruct('::IceGrid::ReplicaGroupDescriptor', 'IceGrid_ReplicaGroupDescriptor', array(
        array('id', $IcePHP__t_string), 
...
if(!class_exists('IceGrid_ApplicationDescriptor'))
{
    class IceGrid_ApplicationDescriptor
    {
    ...
    $IceGrid__t_ApplicationDescriptor = IcePHP_defineStruct('::IceGrid::ApplicationDescriptor', 'IceGrid_ApplicationDescriptor', array(
        array('name', $IcePHP__t_string), 
        array('variables', $IceGrid__t_StringStringDict), 
...
global $IceGrid__t_BoxedStringPrx;

if(!class_exists('IceGrid_BoxedString'))
{
    class IceGrid_BoxedString extends Ice_ObjectImpl
    {
    ...
    class IceGrid_BoxedStringPrxHelper
    {
        public static function checkedCast($proxy, $facetOrCtx=null, $ctx=null)
        {
    ...
    $IceGrid__t_BoxedString = IcePHP_defineClass('::IceGrid::BoxedString', 'IceGrid_BoxedString', -1, false, false, $Ice__t_Object, null, array(
...
if(!class_exists('IceGrid_NodeUpdateDescriptor'))
{
    class IceGrid_NodeUpdateDescriptor
    {
    ...
    $IceGrid__t_NodeUpdateDescriptor = IcePHP_defineStruct('::IceGrid::NodeUpdateDescriptor', 'IceGrid_NodeUpdateDescriptor', array(
        array('name', $IcePHP__t_string), 
...
global $IceGrid__t_BoxedDistributionDescriptorPrx;

if(!class_exists('IceGrid_BoxedDistributionDescriptor'))
{
    class IceGrid_BoxedDistributionDescriptor extends Ice_ObjectImpl
    {
        public function __construct($value=null)
        {
            $this->value = is_null($value) ? new IceGrid_DistributionDescriptor : $value;
        }
    ...
    class IceGrid_BoxedDistributionDescriptorPrxHelper
    {
        public static function checkedCast($proxy, $facetOrCtx=null, $ctx=null)
        {
    ...
    $IceGrid__t_BoxedDistributionDescriptor = IcePHP_defineClass('::IceGrid::BoxedDistributionDescriptor', 'IceGrid_BoxedDistributionDescriptor', -1, false, false, $Ice__t_Object, null, array(
...
if(!class_exists('IceGrid_ApplicationUpdateDescriptor'))
{
    class IceGrid_ApplicationUpdateDescriptor
    {
    ...
    $IceGrid__t_ApplicationUpdateDescriptor = IcePHP_defineStruct('::IceGrid::ApplicationUpdateDescriptor', 'IceGrid_ApplicationUpdateDescriptor', array(
        array('name', $IcePHP__t_string), 
        array('description', $IceGrid__t_BoxedString), 
