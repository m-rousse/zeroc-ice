...
if(!class_exists('IceGrid_ServerState'))
{
...
if(!class_exists('IceGrid_ObjectInfo'))
{
...
if(!class_exists('IceGrid_AdapterInfo'))
{
...
if(!class_exists('IceGrid_ServerInfo'))
{
...
if(!class_exists('IceGrid_NodeInfo'))
{
...
if(!class_exists('IceGrid_RegistryInfo'))
{
...
if(!class_exists('IceGrid_LoadInfo'))
{
...
if(!class_exists('IceGrid_ApplicationInfo'))
{
...
if(!class_exists('IceGrid_ApplicationUpdateInfo'))
{
...
if(!interface_exists('IceGrid_Admin'))
{
...
if(!interface_exists('IceGrid_FileIterator'))
{
...
if(!interface_exists('IceGrid_AdminSession'))
{
