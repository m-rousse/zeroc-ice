...
namespace IceStorm
{
    ...
    if(!class_exists('\\IceStorm\\InvalidSubscriber'))
    {
...
namespace IceStorm
{
    ...
    {
        interface Topic extends \Ice\Object
        {
...
namespace IceStorm
{
    ...
    {
        interface TopicManager extends \Ice\Object
        {
...
namespace IceStorm
{
    ...
    if(!interface_exists('\\IceStorm\\Finder'))
    {
        interface Finder extends \Ice\Object
        {
        ...
        $IceStorm__t_Finder = IcePHP_defineClass('::IceStorm::Finder', '\\IceStorm\\Finder', -1, true, false, $Ice__t_Object, null, null);
